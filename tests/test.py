...
if __name__ == '__main__':
    ...
    """
    #ToDo:
    - Add tests for mandatorily connected elements i.e. GPS on rpiser,
      Accelerometer and Barometer on I2C (not port dependent)
    - Perhaps some kind of detection, but it needs investigation.
      - DHT might be detectable
    - Respect configuration when run